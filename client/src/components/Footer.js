...
function Footer() {
	 return (
		 <React.Fragment>
			 <div className="footer xl:invisible grid grid-cols-5 justify-content-center content-center justify-around px-12 fixed bottom-0 w-full h-14 sm:h-16 z-10 bg-gray-100">
