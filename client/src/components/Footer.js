...
function Footer() {
	 return (
		 <React.Fragment>
			 <div className="grid grid-cols-5 justify-content-center content-center justify-around px-12 fixed bottom-0 w-full max-w-5xl mx-auto h-14 z-10 border-t-[1px]">
